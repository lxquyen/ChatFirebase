...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AIzaSyCDT-bRBN8XO7gjoIIwoRV-zyxc9FI6DxY";
    ...
    public void send() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Timber.e("onGetAllUsersFailure: " + e.getMessage());
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {
                Timber.e("onResponse: " + response.body().string());
            }
        });
    }
